...
def test_run_script_success():
    ...
    run_script("2021-07-01_12-00-00", frame_rate=10, image_width=320, image_height=240, actions=acts, objects=objs)
...
def test_run_script_failure():
    ...
    run_script("2021-07-01_12-00-01", frame_rate=10, image_width=320, image_height=240, actions=acts, objects=objs)
